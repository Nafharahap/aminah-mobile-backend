...
<div class="container mt-4 mb-4">
  ...
  <div class="row">
    <div class="col-lg-6 pt-4 pt-lg-0 order-1 order-lg-1 content">
      <img src="{{ isset($pengajuan) ? asset('pendaftaran/' . $pengajuan->business_image) : 'user.png' }}" class="img-thumbnail" alt="{{ isset($pengajuan) ? $pengajuan->business_name : '-' }}" width="200" onerror="this.onerror=null;this.scr='https://via.placeholder.com/1080x720.png?text=Business%20Image';">
