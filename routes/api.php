...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('lender')->group(function () {
        ...
        Route::get('/mitra', [LenderController::class, 'mitra'])->name('lender.mitra');
        Route::get('/mitra/detail/{funding}', [LenderController::class, 'detailMitra'])->name('lender.mitra.detail');
